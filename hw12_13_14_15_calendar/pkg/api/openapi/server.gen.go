...
type ServerInterface interface {
	...
	// Update event
	// (PUT /events)
	PutEvents(w http.ResponseWriter, r *http.Request)
	// Delete an event
	// (DELETE /events/{id})
	DeleteEventsID(w http.ResponseWriter, r *http.Request, id string)
}
...
// PutEvents operation middleware
func (siw *ServerInterfaceWrapper) PutEvents(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PutEvents(w, r)
	}
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Put(options.BaseURL+"/events", wrapper.PutEvents)
	})
	r.Group(func(r chi.Router) {
